...
export default class AudioHome extends Component {
    ...
    currentTime=()=>{
        song.getCurrentTime((seconds) => console.warn('at ' + seconds));
    }
    jumpTime=()=>{
    ...
    render(){
        return(
            <View style={{flex:1,justifyContent:"center",alignItems:"center"}}>
                ...
                <TouchableOpacity
                style={styles.btn}
                onPress={this.stopSong.bind(this)}>
                ...
                <View style={{width:"100%",marginTop:vh(120),flexDirection:"row",justifyContent:"space-between"}}>
                    <TouchableOpacity 
